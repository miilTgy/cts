...
SRC = $(SRC_DIR)/main.cc $(SRC_DIR)/parser.cc $(SRC_DIR)/treer.cc $(SRC_DIR)/bu.cc $(SRC_DIR)/td.cc $(SRC_DIR)/writer.cc
INC = $(INC_DIR)/common.h $(INC_DIR)/parser.h $(INC_DIR)/treer.h $(INC_DIR)/bu.h $(INC_DIR)/td.h $(INC_DIR)/writer.h
